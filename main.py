...
def main():
    ...
    try:
        ...
        rain_details = Rain(weather_data, START_TIME, END_TIME, TOP_TIMELINE_COUNT, RAIN_CHECK_HOURS_PRIOR,total_hours)
        ...
        report_details = Report(location_details, daylight_details, rain_details, wind_details, temperature_details, START_TIME, END_TIME, total_hours)
        # Sms(report_details)
